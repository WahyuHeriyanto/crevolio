...
<div class="absolute inset-0 overflow-y-auto custom-scrollbar">
    <div class="max-w-[1400px] mx-auto p-8 pb-20">
        ...
        <div id="project-container" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse ($projects as $project)
                ...
                <div class="group bg-white rounded-2xl border border-gray-200 overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer flex flex-col shadow-sm"
                    ...
                    <div class="p-5 flex flex-col flex-1">
                        ...
                        <p class="text-sm text-gray-500 mt-1 mb-4">{{ $field?->name ?? 'General Project' }}</p>
